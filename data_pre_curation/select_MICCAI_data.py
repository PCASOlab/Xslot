...
# Paths
source_folder = r"C:\2data\training_data\video_clips"
destination_folder = r"C:\2data\training_data\selected"
selection_info_folder = r"C:\2data\training_data\selection_information"
...
all_videos = [f for f in os.listdir(source_folder) if f.endswith('.mp4')]

# Randomly select 100 videos
selected_videos = random.sample(all_videos, 100)
