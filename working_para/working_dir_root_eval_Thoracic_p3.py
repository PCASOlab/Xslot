...
if Linux_computer == True:
    ...
    # Dataset_video_pkl_MICCAI_test = working_pcaso_raid + "MICCAI_selected_GT/pkl30fps/"
...
selected_data = ["Thoracic"]  # Multi-dataset selection (example)
